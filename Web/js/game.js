...
function(InfoManager, BubbleManager, Renderer, Map, Animation, Sprite, AnimatedTile,
    ...
    var Game = Class.extend({
        ...
        setServerOptions: function(ws_url, username) {
            this.ws_url = ws_url;
        ...
        connect: function(started_callback) {
            ...
            this.client = new GameClient(this.ws_url);
            ...
            this.client.onDispatched(function(host, port) {  // TODO: 转换 ip:port 为 url
            ...
            this.client.onWelcome(function(id, name, x, y, hp) {
                ...
                if(!self.storage.hasAlreadyPlayed()) {
                    ...
                    self.showNotification("欢迎来到像素大冒险！");
                } else {
                    self.showNotification("欢迎回到像素大冒险！");
